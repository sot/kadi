# -*- coding: utf-8 -*-
#
# kadi documentation build configuration file, created by
...
from kadi import __version__ as release  # noqa: E402
...
latex_documents = [
  ('index', 'kadi.tex', u'kadi Documentation',
...
man_pages = [
    ('index', 'kadi', u'kadi Documentation',
     [u'Tom Aldcroft'], 1)
]
...
texinfo_documents = [
  ('index', 'kadi', u'kadi Documentation',
   u'Tom Aldcroft', 'kadi', 'One line description of project.',
   'Miscellaneous'),
]
