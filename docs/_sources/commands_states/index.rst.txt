...
:func:`~kadi.commands.observations.get_observations()` function. For example::
    ...
    'starcat_date': '2022:075:17:39:50.445',
    'starcat_idx': 174523,
    'source': 'MAR1422A'}
...
Kadi observations since the APR1420B loads also include the original *scheduled* ObsID
in the ``obsid_sched`` field. These can differ in the case of an SCS-107 run where the
ObsID commanding in the observing loads stops running. For observations selected over a
date range you easily can map back to the original load product commanding using the
``obsid_sched`` value
...
For example::
    ...
    >>> obss = apt.Table(kc.get_observations(start, stop))
    >>> obss["obs_start", "obs_stop", "obsid", "obsid_sched", "source"]
    <Table length=6>
        obs_start              obs_stop       obsid obsid_sched  source
            str21                 str21         int64    int64      str8
    --------------------- --------------------- ----- ----------- --------
    2024:366:21:58:02.061 2025:001:08:44:01.810 30550       28365 DEC2324B
    2025:001:09:10:23.636 2025:001:12:48:34.040 30550       29835 DEC2324B
    2025:001:12:48:34.040 2025:001:13:08:03.384 65518       29835  CMD_EVT
    2025:001:13:44:13.046 2025:001:16:38:44.384 65518       25501 DEC2324B
    2025:001:17:13:35.743 2025:001:20:54:35.492 65518       26975 DEC2324B
    2025:001:21:21:03.527 2025:002:01:35:23.276 65518       30500 DEC2324B

    >>> states = kcs.get_states(start, stop, state_keys=["obsid", "obsid_sched"])
    >>> states["datestart", "datestop", "obsid", "obsid_sched"]
    <Table length=6>
        datestart              datestop       obsid obsid_sched
            str21                 str21         int64    int64
    --------------------- --------------------- ----- -----------
    2025:001:00:00:00.000 2025:001:08:47:01.810 30550       28365
    2025:001:08:47:01.810 2025:001:12:48:34.040 30550       29835
    2025:001:12:48:34.040 2025:001:13:11:03.384 65518       29835
    2025:001:13:11:03.384 2025:001:16:38:58.384 65518       25501
    2025:001:16:38:58.384 2025:001:20:57:35.492 65518       26975
    2025:001:20:57:35.492 2025:002:00:00:00.000 65518       30500

Performance
^^^^^^^^^^^

Getting all the observations covering years or more is reasonably fast,
typically a few seconds for the first query and then << 1 sec for subsequent queries.
...
directly::
    ...
    'simpos': -99616,
    'starcat_date': '2022:001:05:21:34.604',
    'starcat_idx': 174028,
...
``clocking``, ``power_cmd``, ``vid_board``, ``fep_count``, ``si_mode``, ``ccd_count``, ``obsid``, ``feps``, ``ccds``
...
``obsid_sched``
  - :class:`~kadi.commands.states.ObsidSchedTransition`

``orbit_point``
  - :class:`~kadi.commands.states.OrbitPointTransition`

``pitch``, ``rasl``, ``off_nom_roll``, ``sun_ra``, ``sun_dec``
  - :class:`~kadi.commands.states.SunAnglesState`

``q1``, ``q2``, ``q3``, ``q4``, ``targ_q1``, ``targ_q2``, ``targ_q3``, ``targ_q4``, ``auto_npnt``, ``pcad_mode``, ``sun_vector_update``
...
``ra``, ``dec``, ``roll``
  - :class:`~kadi.commands.states.RaDecRollState`
...
``sun_pos_mon``, ``battery_connect``, ``eclipse_enable_spm``
