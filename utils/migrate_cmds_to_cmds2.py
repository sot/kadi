...
def add_pre2002_cmds():
    ...
    This uses the "pre2002" scenario with the cmd_events.csv file in the
    ``utils/pre2002`` directory. That file was generated by running the
    ``make_pre2002_cmd_events.py`` script in this directory and then fixing
    things by hand based on state differences with telemetry.
    """
